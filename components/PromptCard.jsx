      ...
      <p className="font-inter text-sm blue_gradient cursor-pointer"
         ...
         {session?.user.id === post.creator._id && pathName === '/profile' && (
          <div className="mt-5 flex-center gap-4 border-t border-gray-100 pt-3">
            <p className="font-inter font-bold text-sm green_gradient cursor-pointer hover:text-green-400"
            onClick={handleEdit} >
              Edit
            </p>
            <p className="font-inter font-bold text-sm orange_gradient cursor-pointer hover:text-orange-400"
